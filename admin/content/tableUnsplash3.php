            <div id='app'> 
                ...
                /////////////////////////////////////////////////////////////////// 
                                        print "<tr>";                 				
                                            ...
                                            print "<button name='rowList' type='text' class='btn btn-default' @click='addRow(item)' :value=\"item.description+'?'+item.city+'?'+item.country+'?'+item.imageown+'?'+item.link+'?'+item.imageurl\"> Add Image </button>";
                                            print "</form>";
