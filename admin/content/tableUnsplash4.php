            <div id='app'> 
                ...
                /////////////////////////////////////////////////////////////////// 
                                        print "<tr>";                 				
                                            ...
                                            print "<form id='theform' method=\"post\">"; 
                                            print "<button id='rowList' name='rowList' type='text' class='btn btn-default' @click='addRow(item);' :value=\"item.description+'?'+item.city+'?'+item.country+'?'+item.imageown+'?'+item.link+'?'+item.imageurl\"> Add Image </button>";
                                            print "</form>";
 

                                            // print "<form id='theform' method=\"post\">"; 
                                            // print "<input type='hidden' name='show' id='show'>";
                                            // print "<button name='rowList' class='btn btn-default' @click='addRow(item);' :value=\"item.description+'?'+item.city+'?'+item.country+'?'+item.imageown+'?'+item.link+'?'+item.imageurl\"> Add Image </button>";
                                            // print "</form>";
